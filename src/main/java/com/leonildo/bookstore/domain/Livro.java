package com.leonildo.bookstore.domain;
...
public class Livro implements Serializable{
	...
	@Length(min = 1, max =100, message = "O campo TITULO deve ter entre 3 a 100 caracteres")
	...
	@Length(min = 3, max = 2000000, message = "O campo TEXTO deve ter entre 3 a 2.000.000 caracteres")
